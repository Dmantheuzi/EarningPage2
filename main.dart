...
var orange = Color(0xFFfc9f6a,0xFF5fa0d6);
var pink = Color(0xFFee528c,0xFFfc9f6a);
var blue = Color(0xFF8bccd6,0xFF60a0d7);
var darkBlue = Color(0xFF60a0d7,0xFF5fa0d6);
var valueBlue = Color(0xFF5fa0d6,0xFFfc9f6a);
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Container(
          color: Color(0xFFf7f8fc,0xFF8bccd6),
          child: ListView(
      children: <Widget>[
          SizedBox(
            height: 32.0,
          ...
          ItemCard('Earnt', 'Last 6 Months', '\$ 3284.00', [orange, pink]),
          SizedBox(
            height: 8.0,
          ),
          ItemCard('Last 6 days', 'Last 6 Months', '\$ 3284.00', [blue, darkBlue]),
          SizedBox(
            height: 32.0,
          ),
          Padding(
            ...
            child: Card(
              child: Column(
                children: <Widget>[
                    ...
                    ValueCard('Pay view','\$ 3284.00','12-03-2019','DBBL - City bank',),
                    ValueCard('Money Paid','\$ 64.00','12-03-2019','DBBL - City bank',),
                    ValueCard('Money made','\$ 6532.21','12-03-2019','DBBL - City bank',),
